...
function sidex(x,y,step=.5) = [p0(x,y),p(x,y,step),p(x+step,y,step),p0(x+step,y)];
function sidey(x,y,step=.5) = [p0(x,y),p(x,y,step),p(x,y+step,step),p0(x,y+step)];
