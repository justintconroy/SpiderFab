...
void strafe_left(unsigned int step)
{
  ...
  while (step-- > 0)
  {
    ...
    {
      //leg 2&1 move
      set_site(2, y_start, x_default + x_offset, z_up);
      wait_all_reach();
      set_site(2, y_start + 2 * y_step, x_default + x_offset, z_up);
      wait_all_reach();
      set_site(2, y_start + 2 * y_step, x_default + x_offset, z_default);
      wait_all_reach();

      move_speed = body_move_speed;

      set_site(0, y_start, x_default + x_offset, z_default);
      set_site(1, y_start + 2 * y_step, x_default + x_offset, z_default);
      set_site(2, y_start + y_step, x_default - x_offset, z_default);
      set_site(3, y_start + y_step, x_default - x_offset, z_default);
      wait_all_reach();

      move_speed = leg_move_speed;

      set_site(1, y_start + 2 * y_step, x_default + x_offset, z_up);
      wait_all_reach();
      set_site(1, y_start, x_default + x_offset, z_up);
      wait_all_reach();
      set_site(1, y_start, x_default + x_offset, z_default);
      wait_all_reach();
    }
    else
    {
      //leg 0&3 move
      set_site(0, y_start, x_default + x_offset, z_up);
      wait_all_reach();
      set_site(0, y_start + 2 * y_step, x_default + x_offset, z_up);
      wait_all_reach();
      set_site(0, y_start + 2 * y_step, x_default + x_offset, z_default);
      wait_all_reach();

      move_speed = body_move_speed;

      set_site(0, y_start + y_step, x_default - x_offset, z_default);
      set_site(1, y_start + y_step, x_default - x_offset, z_default);
      set_site(2, y_start, x_default + x_offset, z_default);
      set_site(3, y_start + 2 * y_step, x_default + x_offset, z_default);
      wait_all_reach();

      move_speed = leg_move_speed;

      set_site(3, y_start + 2 * y_step, x_default + x_offset, z_up);
      wait_all_reach();
      set_site(3, y_start, x_default + x_offset, z_up);
      wait_all_reach();
      set_site(3, y_start, x_default + x_offset, z_default);
      wait_all_reach();
    }
  }
  Serial.println("OK");
